...
userAuth.post('/signin', checkLoginBody, getUserFromDB, verifyPassword, generateAccessToken, generateRefreshToken, updateRefreshTokenInDB, (req, res) => {
...
userAuth.post('/signup', checkSignUpBody, hashPassword, createUserinDB, generateAccessToken, generateRefreshToken, updateRefreshTokenInDB, (req, res) => {
    delete req?.userFromDB?.password
