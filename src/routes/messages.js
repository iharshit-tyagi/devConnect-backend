...
import { sendMessage,getMessagesForAMatch } from "../controllers/messageController.js";
...
messageRoute.post('/getMessages',checkAuthStatus,getMessagesForAMatch,(req,res)=>{
    res.status(200).json({
        message :'Sent Successfully!',
